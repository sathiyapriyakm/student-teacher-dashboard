...
<div className="col-xl-6 col-lg-6">
    <div className="card shadow mb-4">
        ...
        <ul>
            ...
            <li>Being prepared for classes with all necessary supplies</li>
...
<div className="col-xl-6 col-lg-6">
    <div className="card shadow mb-4">
        ...
        <div className="card-body">
            ...
            <li>Collaborate with other teachers, parents and stakeholders and participate in regular meetings</li>
            <li>Plan and execute educational in-class and outdoor activities and events
</li>
            <li>Observe and understand students’ behavior and psyche and report suspicions of neglect, abuse etc.
</li>
            <li>Develop and enrich professional skills and knowledge by attending seminars, conferences etc.</li>
             </ul>
