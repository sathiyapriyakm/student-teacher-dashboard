...
export function StudentEdit() {
  ...
  const navigate = useNavigate();
    ...
    const editStudent =(updatedStudent) => {
      fetch(`https://62aa7f0d371180affbd633f8.mockapi.io/students/${student.id}`,
      {
        method:"PUT",
        body: JSON.stringify(updatedStudent),
        headers:{"Content-Type":"application/json"},
    }).then(()=>{navigate("/StudentDetails")}).catch((e)=>console.log("ERROR"));
    //  navigate("/Movies");
    };
  ...
  return <div
      ...
      className="add-student-form" >
        ...
        helperText={touched.standard&&errors.standard?errors.standard:""}
        />
       <TextField
       className="add-student-name"
