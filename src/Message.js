    ...
    <CardContent>
     <div className="teacher-specs"> 
      <h3 className="teacher-name mb-4">
        {`Name: ${name}`} </h3>
        <p  className="teacher-rating"><b>{`Class:`}</b> {` ${standard}`}</p>
        <p  className="teacher-rating"><b> {`Address:`}</b>{` ${address}`}</p>
         <p  className="teacher-rating"><b>{`Contact number:`}</b> {` ${contact_number}`}</p>
    </div> 
    </CardContent>
      <CardActions>
